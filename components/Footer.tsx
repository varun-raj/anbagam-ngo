    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-sm text-white font-medium bg-blue-600/40 hover:bg-blue-600/60 border border-blue-500/40 px-4 py-2 rounded-full mb-6 transition-colors"
        >
